...
public enum DbfCodePages {
	...
	;
/*	
	Cp737(0x6A, "Cp737"),  Cp852(0x64,
			"Cp852"), Cp861(0x67, "Cp861"), Cp865(0x66, "Cp865"), Cp866(0x65,
			"Cp866"), Cp857(0x6B, "Cp857"), Cp1250(0xC8, "Cp1250"), Cp1251(
			0xC9, "Cp1251"),  Cp1253(0xCB, "Cp1253"), Cp1254(
			0xCA, "Cp1254");
*/
	private int dbfCode;
	...
	protected DbfCodePages getByCharSet(String charSet) {
		DbfCodePages dcp = null;

		for (DbfCodePages dcps : DbfCodePages.values()) {
			if (dcps.getCharsetName().equals(charSet)) {
				dcp = dcps;
				break;
			}			
		}
